  ...
  render() {
    return (
      ...
      <div className="col-lg-6 col-md-12" > <Widget1 Widget1={Widget1}/></div> 
        ...
        <div className="wid1">
      <div className="col-lg-6 col-md-12"> <Widget2 Widget2={Widget2}/></div>
        </div>
        </div>
      
        <div className="row">
        <div className="wid1">
        <div className="col-lg-6 col-md-12">  <Widget3 Widget3={Widget3}/></div>
    
       </div>
       <div className="wid1">
        <div className="col-lg-6 col-md-12">  <Widget4 Widget4={Widget4}/></div>
        </div>
     
      </div>
        <div className="row">
        <div className="wid1">
        <div className="col-lg-6 col-md-12">  <Widget5 Widget5={Widget5}/></div>
    
       </div>
       <div className="wid1">
        <div className="col-lg-6 col-md-12">  <Widget6 Widget6={Widget6}/></div>
        </div>
